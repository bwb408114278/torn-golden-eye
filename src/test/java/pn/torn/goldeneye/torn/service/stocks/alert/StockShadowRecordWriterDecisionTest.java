...
class StockShadowRecordWriterDecisionTest {
    ...
    private record EvaluationView(boolean acceptedFormal)
        ...
        @Override
        public pn.torn.goldeneye.torn.service.stocks.alert.buy.StockBuyStrategy primaryStrategy() {
            return null;
        }

        @Override
        public java.util.List<pn.torn.goldeneye.torn.service.stocks.alert.buy.StockBuyStrategy> matchedStrategies() {
            return List.of();
        }
        ...
        @Override
        public pn.torn.goldeneye.torn.service.stocks.alert.buy.BuyContext context() {
            return null;
        }
