...
public class OcRotationQueryStrategyImpl extends PnMsgStrategy {
    ...
    public List<? extends QqMsgParam<?>> handle(long groupId, QqRecMsgSender sender, String msg) {
        ...
        String blockRank = settingDao.querySettingValue(TornConstants.SETTING_KEY_OC_BLOCK_RANK + rank);
        ...
        String enableRank = settingDao.querySettingValue(TornConstants.SETTING_KEY_OC_ENABLE_RANK + rank);
