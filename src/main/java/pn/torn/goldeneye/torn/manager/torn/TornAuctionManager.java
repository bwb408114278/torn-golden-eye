...
public class TornAuctionManager {
    ...
    private static final String ARMOR_BONUS_FORMULA = "IFS(\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Impenetrable\",\n  \"拦截\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%子弹伤害\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Impregnable\",\n  \"格挡\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%近战伤害\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Invulnerable\",\n  \"净化\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%负面状态\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Imperviable\",\n  \"提升\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%血量上限\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Immutable\",\n  \"提升\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%def属性\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Irrepressible\",\n  \"提升\" & bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%dex属性\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Impassable\",\n  bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%几率无敌\",\n  bitable::$table[#{tableId}].$field[#{bonusTitleId}] = \"Insurmountable\",\n  \"当自身生命值低于四分之一时，降低\" &bitable::$table[#{tableId}].$field[#{bonusValueId}] & \"%所受伤害\",\n  TRUE,\n  \"\"\n)";
