...
import pn.torn.goldeneye.torn.service.faction.oc.planning.OcRefreshVectorEvaluator.VectorEvaluation;
...
class OcRefreshVectorSearcher {
     ...
     * @return 向量搜索结果
     */
    SearchOutcome search(OcRefreshSafetyRequest request,
     ...
     */
    boolean touchesSearchLimit(List<OcRefreshSafetyResult.SafeCandidate> candidates) {
