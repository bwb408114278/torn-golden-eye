...
/**
 * 股票影子账本服务 - 维护原始信号事件、候选影子批次、无限资金影子批次与拒绝观察批次
 * <p>
 * 本服务承担四类不产生即时群消息的账本维护职责,作为信号回测、策略迭代与
 ...
 * <h3>候选影子批次</h3>
 * <p>
 * SHADOW模式独立5槽×20亿候选影子账本,与正式组合共享规则但完全隔离,
 * 由 {@link StockBuySignalEvaluator} 候选接纳阶段创建,本服务不创建候选影子批次。
 *
 * <h3>无限资金影子批次</h3>
 * <p>
