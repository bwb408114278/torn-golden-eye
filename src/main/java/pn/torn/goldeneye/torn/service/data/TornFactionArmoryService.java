...
public class TornFactionArmoryService {
    ...
    public void init() {
        ...
        String value = settingDao.querySettingValue(SettingConstants.KEY_FACTION_ARMORY_LOAD);
        LocalDateTime from = DateTimeUtils.convertToDate(value).atTime(10, 0, 0);
    ...
    public void spiderFactionData() {
        ...
        settingDao.updateSetting(SettingConstants.KEY_FACTION_ARMORY_LOAD, DateTimeUtils.convertToString(to));
        addScheduleTask(to.plusDays(1).atTime(10, 0, 0));
    }
    ...
    private void addScheduleTask(LocalDateTime execTime) {
        taskService.updateTask("faction-armory-reload", this::spiderFactionData, execTime);
    }
}