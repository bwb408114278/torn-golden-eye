...
public class OcRosterMatcher {
     ...
     * @return 加入顺序比较器
     */
    private Comparator<MatchedSlot> orderComparator(OcTeamDemand demand,
                                                    boolean differentialWorkingHour) {
     ...
     * @return 顺序评分，越小越优
     */
    private long calculateOrderScore(List<MatchedSlot> order, OcTeamDemand demand,
                                     boolean differentialWorkingHour) {
        long score = 0;
     ...
     * @return 顺序价值
     */
    private long orderValue(MatchedSlot match, OcTeamDemand demand,
                            boolean differentialWorkingHour) {
