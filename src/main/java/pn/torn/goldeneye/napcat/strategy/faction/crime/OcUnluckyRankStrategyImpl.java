...
public class OcUnluckyRankStrategyImpl extends SmthMsgStrategy {
    ...
    public String getCommand() {
        return BotCommands.OC_UNLUCKY_RANK;
    }

    @Override
    public String getCommandDescription() {
        return "查询近90天OC非酋，格式g#" + BotCommands.OC_UNLUCKY_RANK + "(#帮派ID，0为总榜)";
    }
    ...
    public List<? extends QqMsgParam<?>> handle(long groupId, QqRecMsgSender sender, String msg) {
        ...
        return super.buildImageMsg(OcSuccessRankTableBuilder.buildImage(rankList, title, false,
